...
class Collection extends XhbCollection implements \xhb\models\Resource\Iface\Operation\Collection
{
    public function __construct($params = array()) {
        parent::__construct($params);
        $this->_init('\\xhb\\models\\Operation', 'id', Operation::MAIN_TABLE);
    }
